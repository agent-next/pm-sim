...
- **Exact fee model** — `bps/10000 × min(price, 1-price) × size` (summed per fill level)
- **Slippage tracking** — reports execution vs best quote (primary) and midpoint (context), in basis points
